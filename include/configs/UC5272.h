...
#define CONFIG_WATCHDOG_TIMEOUT		30
...
#else
#define CFG_ENV_ADDR		0x10c40000
#define CFG_ENV_SECT_SIZE	0x10000
#define CFG_ENV_IS_IN_FLASH	1
#endif

#define CONFIG_UC5272_DISABLE_CMDS \
	(CFG_CMD_LOADS | CFG_CMD_LOADB | CFG_CMD_AUTOSCRIPT)

#define CONFIG_COMMANDS \
	(( CONFIG_CMD_DFL & ~(CONFIG_UC5272_DISABLE_CMDS) ) | CFG_CMD_JFFS2)
...
#define CFG_FLASH_BASE		0x10c00000

#ifdef	CONFIG_MONITOR_IS_IN_RAM
#define CFG_MONITOR_BASE	0x10c20400
#else
...
#define	CFG_JFFS2_FIRST_SECTOR	12
...
#define	CONFIG_HOSTNAME		apeg
#define	CONFIG_SERVERIP		192.168.2.3
#define	CONFIG_IPADDR		192.168.2.140
#define CONFIG_BOOTARGS		"root=/dev/mtdblock3 rootfstype=jffs2 console=null rw"
#define CONFIG_BOOTCOMMAND	"fsload 500000 boot/linux.img; bootm"
